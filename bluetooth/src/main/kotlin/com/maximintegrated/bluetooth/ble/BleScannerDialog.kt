...
class BleScannerDialog : AppCompatDialogFragment() {
    ...
    companion object {
        ...
        const val ARG_DEVICE_NAME_PREFIXES = "deviceNamePrefixes"
        const val ARG_DIALOG_TITLE = "dialogTitle"

        fun newInstance(
            dialogTitle: String? = null,
            deviceNamePrefixes: ArrayList<String>? = null
        ): BleScannerDialog {
            val fragment = BleScannerDialog()
            fragment.arguments = Bundle().apply {
                putString(ARG_DIALOG_TITLE, dialogTitle)
                putStringArrayList(ARG_DEVICE_NAME_PREFIXES, deviceNamePrefixes)
            }
    ...
    private val deviceNamePrefixes: ArrayList<String>?
        get() = arguments?.getStringArrayList(ARG_DEVICE_NAME_PREFIXES)
